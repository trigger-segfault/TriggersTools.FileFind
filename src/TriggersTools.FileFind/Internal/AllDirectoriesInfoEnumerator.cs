...
namespace TriggersTools.IO.Windows.Internal {
	/// <summary>
	/// A <see cref="FileFindInfo"/> enumerator for <see cref="SearchOrder.AllDirectories"/> order.
	/// </summary>
	internal class AllDirectoriesInfoEnumerator : IEnumerator<FileFindInfo> {
		...
		private readonly List<EnumerationInfoState> stateList;
		...
		public AllDirectoriesInfoEnumerator(SearchInfo search) {
			...
			stateList = new List<EnumerationInfoState> { currentState };
			stateIndex = 0;
		}
