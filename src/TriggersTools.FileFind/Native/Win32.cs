...
namespace TriggersTools.IO.Windows.Native {
	...
	internal static partial class Win32 {
		...
		/// <summary>Gets if <see cref="FindFirstFileEx"/> supports extra options.</summary>
		public static bool SupportsExtraFindOptions { get; }
		
		static Win32() {
			SupportsExtraFindOptions = (Environment.OSVersion.Version >= new Version(6, 1));
		}
	}
}
